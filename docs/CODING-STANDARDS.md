...
- **Vitest** مع عتبة تغطية للحزم الخالصة، والمجموعة الذهبية كبوابة دقة (>=99.7% **لكل سؤال**، والوحدة والمقام في [`PLAN.md`](PLAN.md) القسم 11ب، **ومعها سقف تحذير 2٪ من الأسئلة وسقف رفض 2٪ من الأوراق، والثلاثة تُنشر معاً أو لا يُنشر أحدها**).
