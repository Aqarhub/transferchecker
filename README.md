...
packages/account/      الدول والأنظمة القانونية، وقواعد التسجيل والجلسة والموافقة
packages/ui/           نظام التصميم رمزاً: الرموز والأيقونات والأجزاء وسجل اللغات
apps/site/             الموقع التسويقي وملفات الزواحف بثماني لغات، بلا إطار وبلا جافاسكربت
apps/web/              لوحة التحكم: خمس شاشات، كل لغة ملفاً كاملاً على القرص
